...
-- Forum threads: aggregation index for community forum threads
-- Source of truth remains the repos (repo_blocks); this is a denormalized read cache.
...
-- Forum posts: aggregation index for community forum posts
...
-- Event RSVPs: aggregation index for community event attendance
