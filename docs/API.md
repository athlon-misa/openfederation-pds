...
| POST | `net.openfederation.admin.importRepo` | Admin | Registered admin endpoint intended for bounded CAR import; currently nonfunctional pending schema-aligned block storage and real CAR/MST record indexing |
